...
window.onload = function () {
    const picas = '<span style="color:black">♠</span>';
    const corazones = '<span style="color:red">♥</span>';
    const rombos = '<span style="color:red">♦</span>';
    const trebol = '<span style="color:black">♣</span>';
    ...
    function paloAleatorio() {
        ...
        paloArriba.innerHTML = palosArr[num];
        paloAbajo.innerHTML = palosArr[num];
    }
